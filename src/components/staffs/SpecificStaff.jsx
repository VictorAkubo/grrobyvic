...
import "../../styles/staffs/SpecificStaff.css"
...
const SpecificStaff = () => {
    ...
    return (
        <>
            ...
            <OrderNav header="Staffs - Goodluck Victor" />
                ...
                <div className='staffprofileandaction'>
                    ...
                    <div className='staffsellipsis'>
                        <img className="ellips" src="/ellipsis.svg" onClick={() => setActionCalledStaff(!actionCalledStaff)} />
                        {
                            actionCalledStaff && (
                                <div>
                                    <div className="actionstaff">
                                        <p onClick={() => { setUpdateRole(true); }}>Assign role/privilege</p>
                                        <p onClick={() => setResetPassword(true)}>Reset Password</p>
                                        <p onClick={() => setreset2fa(true)}>Reset 2FA</p>
                                        <p onClick={() => setSuspend(true)}>Suspend account</p>
                                        <p onClick={() => setRemove(true)} className="delete">Delete account</p>
                                    </div>
                                </div>
                            )
                        }
